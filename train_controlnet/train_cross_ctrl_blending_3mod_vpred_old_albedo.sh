...
export OUTPUT_DIR="outputs-0409/debug123_3mod_vpred_512_large_old_dataset_albedo/"


accelerate launch --config_file=accelerate_configs/0123.yaml --mixed_precision="fp16" train_controlnet/train_cross_ctrl_blending_3mod_vpred_old_albedo.py \
