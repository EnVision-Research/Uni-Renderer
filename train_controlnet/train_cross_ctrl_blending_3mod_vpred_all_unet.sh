...
export OUTPUT_DIR="outputs/debug123_3mod_vpred_512_all_unet/"


accelerate launch --config_file=accelerate_configs/8cards.yaml --mixed_precision="fp16" train_controlnet/train_cross_ctrl_blending_3mod_vpred_all_unet.py \
